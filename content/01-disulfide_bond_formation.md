...
{% callout(alt = "⚗️") %} Тета-дефензины на мой взгляд особо уникальный класс пептидов. В огранизме млекопитащих они выполняют роль этаких мощных `эндогенных антибиотиков` [54,55]; проявляют антивиральную [56] (в том числе, анти-ВИЧ [57]) активность; имеют иммуно-модулирующие свойства. 
{% end %}
