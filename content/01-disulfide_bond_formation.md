...
{% callout() %}Это нам сейчас легко рассуждать об этом всем, а вообще-то за инсулин дали аж две нобелевские премии в свое время - одну за открытие по физиологии и медицине, а потом - уже по химии, за определение структуры, Фредерику Сенгеру. Вот такая примечательная молекула, что аж два раза удостоилась.
{% end %}
